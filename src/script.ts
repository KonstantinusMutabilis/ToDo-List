...
taskForm?.addEventListener("submit", e => {
    ...
    if (taskTitle?.value == "" || taskTitle?.value == null || taskContext?.value == "" || taskContext?.value == null) return
    const newTask: Task = {
...
function addTaskListItem(task: Task) {
    ...
    function ifDoneCheck(checkbox: HTMLInputElement) {
